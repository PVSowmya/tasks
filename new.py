      ...
      if self.txt_new_pass.get()=="" :
         ...
         try:
            ...
            if row==None:
               ...
               messagebox.showerror('Error','Please enter ',parent=self.root)
            else:
               cur.execute('update register set password=%s where emailid=%s ',(self.txt_new_pass.get(),self.email_txt.get()))
               con.commit()
               con.close()
      ...
      if self.email_txt.get()=="":
         ...
         try:
            ...
            if row==None:
               ...
               new_password.place(x=50,y=70)
               self.txt_new_pass=Entry(self.root2,font=("times new roman",15),bg="lightgray")
               self.txt_new_pass.place(x=70,y=120,width=150)
               ...
               btn_change_password.place(x=110,y=180)
